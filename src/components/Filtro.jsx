    ...
    return <form className="my-4">
        <div className="mb-2">
            ...
            <select className="border rounded-sm w-40"
                ...
                // Funcion para que cambie la seleccion al hacer click
        ...
        <button type="button" className="bg-orange-600 py-2 px-4 rounded-md text-white hover:bg-orange-200 hover:text-gray-700"
            onClick={function () {
